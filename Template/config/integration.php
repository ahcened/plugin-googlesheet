<h3><img src="<?= $this->url->dir() ?>plugins/RocketChat/googlesheet-icon.png"/>&nbsp;Google Sheet</h3>
<div class="panel">
    <?= $this->form->label(t('Webhook URL profile configuration'), 'rocketchat_webhook_url') ?>
